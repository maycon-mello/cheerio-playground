...
`<!--
 ...
 The application state persist in localStorage, so you don't lost your changes
 ...
 * This plagyround include helpers with functions like
 * wrapTextChildren, dumpTable...
 */
const $body = $('body');

// Creating and inserting a new element on body
...
// Logs example
console.log("You can create logs to debug, to see it click in the logs button");
console.log(myDiv);
